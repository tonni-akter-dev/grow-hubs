    ...
    return (
        <div className='mt-[60px] mx-auto sell_bg '  >
            <div className='text-center'>
                ...
                <h1 className='mb-4 text-h3 lg:text-display text-neutral-13 font-bold leading-[35px] lg:leading-[57px]'>Sell More, Together <br className='lg:hidden block' /> With <br className='lg:block hidden' /> Zero Marketing Costs</h1>
