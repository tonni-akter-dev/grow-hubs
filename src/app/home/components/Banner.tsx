...
import bottomShadow from "../../../../public/home/banner_bottom_shadow.png";
  ...
  return (
    <div className=" bg-[#020E1B] pt-[36px] h-full relative mb-[50px] lg:mb-[90px] overflow-hidden">
      <div className="flex justify-center z-40 relative">
        <button className="py-3 px-3.5 bg-[#1B162699] rounded-[100px] text-neutral-50  lg:text-body text-caption">
          Build for you
        </button>
      </div>
      <div className="">
      ...
      <div className="text-center lg:px-0 px-5 relative z-40 ">
        <h1 className="text-[36px] lg:text-h1 font-bold  leading-[40px] lg:leading-[80px] banner_heading my-4 ">
          Built for Creators. <br /> Powered for Profit
        </h1>
        <p className="text-body-sm lg:text-h6 text-white leading-[30px] mb-8">
          Create and sell courses, consulting services, and communities - with
          Zero <br className="lg:block hidden" /> marketing cost and a built-in
          sales network.
        </p>
        <div className="flex flex-col items-center ">
          <div className="flex justify-between md:flex-row w-full lg:w-[516px] bg-[#3B3B4B] rounded-[100px] items-center h-[66px] lg:h-[74px]">
            ...
            <button
              style={{
                background:
                  "linear-gradient(214deg, #3F7DFF 20.22%, #2E9FE5 77.53%)",
              }}
            ...
            >
              <p>Start for Free </p>
              <p className="text-caption font-normal leading-[18px] whitespace-nowrap">
      ...
      <div className="absolute bottom-0  left-[14%] lg:block hidden">
        <Image src={bottomShadow} alt="" />
      </div>
      <BannerSelling />
    </div>
  );
