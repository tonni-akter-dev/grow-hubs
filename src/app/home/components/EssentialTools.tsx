    ...
    return (
        <div className='bg-[#FDF6E8] pt-[100px]'>
            <div className='text-center'>
                ...
                <p className=' text-body-sm lg:text-h6 text-neutral-9 lg:mb-6  font-medium leading-5 lg:leading-[30px] '>Create diverse products on the platform and <br className='lg:hidden block' /> leverage our <br className='lg:block hidden' /> powerful tools to drive sales within <br className='lg:hidden block' /> and beyond GrowHubs.</p>
            </div>
            <EssentialToolCard />
        </div>
    )
