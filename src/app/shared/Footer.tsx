  ...
  return (
    <footer className="bg-[#041427] mt-[67px] pt-14">
      <div className="container">
        ...
        {/* Columns */}
        <div className="flex flex-col lg:flex-row justify-between mb-[51px] gap-10">
          {/* Products / Links / Scale */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-[100px]">
            <div>
              <h3 className="text-h6 text-white font-medium leading-[30px] mb-6">
                Products
              </h3>
              <ul className="space-y-4">
                {['Course','Community','Consultancy','Podcasts','Merchandise','Events'].map((item,i)=>(
                  <li key={i} className="text-white opacity-70 font-medium leading-6 text-body">{item}</li>
                ))}
              </ul>
            </div>
            <div>
              <h3 className="text-h6 text-white font-medium leading-[30px] mb-6">Links</h3>
              <ul className="space-y-4">
                {['Products','Torvat','Resources','Blog','Pricing'].map((item,i)=>(
                  <li key={i} className="text-white opacity-70 font-medium leading-6 text-body">{item}</li>
                ))}
              </ul>
            </div>
            <div>
              <h3 className="text-h6 text-white font-medium leading-[30px] mb-6">Scale</h3>
              <ul className="space-y-4">
                {['Co-sell','Email Marketing','Funnels & Automations','Third party Integrations'].map((item,i)=>(
                  <li key={i} className="text-white opacity-70 font-medium leading-6 text-body">{item}</li>
                ))}
              </ul>
            </div>
          ...
          <div className="w-full lg:w-1/3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-2 mb-10">
              {['Instagram','Twitter','TikTok','Facebook','LinkedIn','YouTube'].map((item,i)=>(
                <div key={i} className="flex items-center text-white opacity-70 leading-6 text-body gap-1">
                  <span>{item}</span>
                  {/* Arrow Icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                    <path d="M7.8 6.3h5.8v5.8L6.2 13.7" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              ))}
            </div>
            ...
            <div>
              <h3 className="text-h6 text-white font-medium leading-[30px] mb-2">Address</h3>
              <p className="text-white opacity-70 leading-6 text-body mb-6">
