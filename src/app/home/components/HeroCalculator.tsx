...
// export default function CosellHeroCalculator({ openCalculator }) {
...
//                       <tr><td className="px-4 py-3 text-neutral-5">Price per membership</td><td className="px-4 py-3 text-right font-medium">{formatMoney(price, currency)}</td></tr>
//                       <tr><td className="px-4 py-3 text-neutral-5">Expected buyers / month</td><td className="px-4 py-3 text-right font-medium">{stats.buyers.toLocaleString()}</td></tr>
...
//                   <div className="px-4 py-3 bg-neutral-50 text-neutral-900 font-medium flex items-center gap-2">
...
//                         <li>We tranneutral ad spend into CAC using a blended CPC and a conservative purchase conversion rate (~2.5%): <span className="font-mono">CAC ~ CPC / Purchase CVR</span>.</li>
...
//                   <table className="w-full text-sm">
//                     <tbody className="divide-y">
//                       <tr><td className="px-4 py-3 text-neutral-5">Blended CPC (USD)</td><td className="px-4 py-3 text-right font-medium">{"$" + blendedCPC.toFixed(2)}</td></tr>
//                       <tr><td className="px-4 py-3 text-neutral-5">CAC per sale (USD)</td><td className="px-4 py-3 text-right font-medium">{"$" + (blendedCPC / Math.max(0.0001, purchaseCVR)).toFixed(0)}</td></tr>
//                       <tr><td className="px-4 py-3 text-neutral-5">Price per membership</td><td className="px-4 py-3 text-right font-medium">{formatMoney(price, currency)}</td></tr>
...
//                       <tr><td className="px-4 py-3 text-neutral-5">Expected buyers / month (solo)</td><td className="px-4 py-3 text-right font-medium">{stats.buyersSolo.toLocaleString()}</td></tr>
...
// function StatCard({ label, value, sub, highlight }: { label: string, value: number, sub: string, highlight: false }) {
//   return (
//     <div
...
//   return (
//     <div className="rounded-2xl border border-neutral-11 bg-white p-5">
