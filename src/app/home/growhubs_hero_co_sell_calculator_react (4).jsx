...
// Growhubs Hero Co-sell Calculator (clean + two-table comparison)
// - Plain React (no TypeScript types)
// - Minimal UI kept from first version + clear profit comparison tables
// - Implements: sales opportunity lift vs solo, earnings without product, minimal-price revenue, and probability boost from engaged contacts
      ...
      <div className="bg-white/70 backdrop-blur rounded-2xl shadow-lg border border-slate-200 p-6 md:p-10">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Panel title="Your product reach & conversions (Growhubs)">
            <NumberRow label="Minimum sales / month" value={minSales} onChange={setMinSales} />
          ...
          <Panel title="Your contacts & intermediary earnings">
            <NumberRow label="Your contacts on platform (C)" value={myContacts} onChange={setMyContacts} />
