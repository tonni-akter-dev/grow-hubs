...
const CircularImages = () => {
    ...
    return (
        <div className="relative w-4xl h-[1000px] flex items-center justify-center cloud_bg">
            <div>
                <div className="absolute right-[15%] top-[18%] flex flex-col items-center gap-2">
            ...
            <div className="absolute z-10 rounded-full size-[460px] flex items-center justify-center">
                ...
                <div className="absolute z-20 rounded-full border-2 border-[#E5D9CB]  size-[362px] flex items-center justify-center">
                    ...
                    <div className="absolute z-30 rounded-full border-2 border-[#E4D8C5] size-[257px] flex items-center justify-center" style={{ boxShadow: '0 -2.09px 8.36px 10.45px #E1D9CE' }}>
                    ...
                    >
                        <div className="">
                            <Image
                                ...
                                style={{ mixBlendMode: 'luminosity', aspectRatio: 'revert-layer' }}
                            />
                        </div>
