        ...
        <div className="container mt-[37px] lg:mt-[73px] relative z-40 ">
            <div className=' bg-[#00000033] border border-[#505152] rounded-[40px] pt-8  pb-11 mt-[73px]  '>
                <div className='flex justify-between items-start lg:items-center mb-4  ps-4 lg:ps-8 pe-4'>
                    ...
                    <button className='text-neutral-50  text-body-sm lg:text-body leading-[17px] py-2 lg:py-3 px-4 lg:px-5 border hover:bg-white transition-all ease-in-out duration-300 border-neutral-50 cursor-pointer rounded-[100px]  hover:text-black' onClick={handleCalculatorToggle}>
                        {
