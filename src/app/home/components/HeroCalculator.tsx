...
//   const [price] = useState<number>(9); // monthly membership price (treat as minimal price)
...
//   const reachOwned = 0.6; // you reach 60% of engaged contacts per promo
...
//                   <div className="px-4 py-3 bg-blue-950 text-neutral-2 font-medium">
//                     Growhubs - No ad spend
//                   </div>
//                   <table className="w-full text-sm">
//                     <tbody className="divide-y divide-neutral-11">
//                       <tr>
//                         <td className="px-4 py-3 text-neutral-5">
//                           Price per membership
//                         </td>
//                         <td className="px-4 py-3 text-right text-neutral-1 font-medium">
...
//                           {formatMoney(stats.profitPerSale_Growhubs, currency)}
//                         </td>
//                       </tr>
//                       <tr>
//                         <td className="px-4 py-3 text-neutral-5">
...
//                         </td>
//                         <td className="px-4 py-3 text-right text-lg font-semibold text-emerald-700">
//                           {formatMoney(stats.mrr, currency)}
//                         </td>
//                       </tr>
//                     </tbody>
//                   </table>
...
//                         How we estimate &quot;ads required&quot; costs
//                       </p>
//                       <ul className="list-disc pl-5 mt-2 space-y-1">
//                         <li>
//                           Based on the average monthly ad budget a typical
//                           online coach invests across Google Ads, Facebook,
//                           Instagram, TikTok, and LinkedIn to drive cold traffic.
//                         </li>
//                         <li>
//                           We translate ad spend into CAC using a blended CPC and
//                           a conservative purchase conversion rate (~2.5%):{" "}
//                           <span className="font-mono">
//                             CAC ~ CPC / Purchase CVR
//                           </span>
//                           .
//                         </li>
//                         <li>
//                           These costs are effectively required on tool-only
//                           platforms (no built-in co-selling) such as Kajabi,
//                           Teachable, Thinkific, Skool, or HubSpot - because you
//                           must buy your own reach.
//                         </li>
//                       </ul>
...
//                           <span className="font-mono">Price - CAC</span>; it can
//                           be negative when{" "}
//                           <span className="font-mono">CAC &gt; Price</span>.
//                         </li>
//                         <li>
//                           Monthly profit uses your solo baseline buyers (from
//                           your own contacts only), not the shared Growhubs
//                           network.
//                         </li>
//                       </ul>
//                       <p className="mt-3 text-neutral-5">
//                         Notes: Benchmarks are illustrative; real results vary by
//                         niche, creatives, and funnel quality. Platform names are
//                         examples only.
//                       </p>
//                     </InfoTip>
//                   </div>
...
//                           Blended CPC (USD)
//                         </td>
//                         <td className="px-4 py-3 text-right font-medium text-neutral-5">
...
//                           {"$" +
//                             (
//                               blendedCPC / Math.max(0.0001, purchaseCVR)
//                             ).toFixed(0)}
//                         </td>
//                       </tr>
//                       <tr>
...
//                           <span
//                             className={
//                               stats.profitPerSale_Paid >= 0
//                                 ? "text-emerald-700"
//                                 : "text-rose-600"
//                             }
//                           >
//                             {formatMoney(stats.profitPerSale_Paid, currency)}
//                           </span>
//                         </td>
//                       </tr>
//                       <tr>
//                         <td className="px-4 py-3 text-neutral-5">
//                           Expected buyers / month (solo)
//                         </td>
//                         <td className="px-4 py-3 text-right text-neutral-5 font-medium">
//                           {stats.buyersSolo.toLocaleString()}
//                         </td>
//                       </tr>
//                       <tr>
//                         <td className="px-4 py-3 text-neutral-5">
...
//                           <span
//                             className={
//                               stats.monthlyProfitPaid >= 0 &&
//                               stats.profitPerSale_Paid >= 0
//                                 ? "text-emerald-700"
//                                 : "text-rose-600"
//                             }
//                           >
//                             {formatMoney(stats.monthlyProfitPaid, currency)}
//                           </span>
//                         </td>
//                       </tr>
//                       <tr>
//                         <td className="px-4 py-3 text-neutral-5">Outcome</td>
...
//               <p className="mt-3 text-xs text-neutral-5">
//                 Solo baseline uses only your engaged contacts: buyersSolo = C *
//                 engagement * reachOwned * promos * CTR * CVR (rounded). Growhubs
//                 buyers come from network co-selling: buyers = N * r * F * CTR *
//                 CVR.
//               </p>
//             </div>

//             <p className="mt-6 text-xs text-neutral-5 leading-relaxed">
//               Assumptions: N=10,000; r=5%; F=50; CTR=8%; CVR=2.5%; blended
//               CPC=$1.49; purchase CVR=2.5%; reachOwned=60%; promos=1. Break-even
//               for paid ads is roughly price &gt;= CAC. Probability uses Poisson:
//               P(&gt;=1) = 1 - exp(-lambda), lambda = expected sales from your
//               contacts this month.
//             </p>
...
//                   (rPct / 100) *
//                   F
//                 ).toLocaleString()} in-platform views when ${rPct}% co-sell your offer.`}
//               />
//               <ExplainerCard
//                 title="Simple viral step"
//                 body={`If everyone invites 1 person, the network grows from ${N.toLocaleString()} to ${(
//                   N * 2
//                 ).toLocaleString()} members.`}
//               />
//               <ExplainerCard
//                 title="Your next move"
//                 body="Invite contacts and keep them engaged to grow intermediary commissions. Increase engagement to raise your chance of at least 1 commission."
//               />
//             </div>
//           </div>
//         )}
...
//     >
//       <p className="text-body-sm lg:text-body">{label ? label : ""}</p>
...
//         } w-[min(95vw,42rem)] p-4 text-[13px] text-neutral-5 bg-white border border-neutral-11 rounded-lg shadow-xl left-0 top-full mt-2 whitespace-normal leading-relaxed`}
//       >
